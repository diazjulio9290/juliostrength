export const metadata = { title: "Thanks — message received", robots: { index: false } };
  ...
  return (
    <main className="min-h-screen grid place-items-center bg-neutral-950 text-neutral-100 px-6">
      <div className="max-w-lg text-center">
        ...
        <a href="/" className="mt-6 inline-block rounded-xl px-5 py-3 bg-white text-neutral-900 font-semibold">Back to home</a>
      </div>
    </main>
  );
}
