    ...
    <main className="mx-auto max-w-3xl px-4 py-16">
      <article className="legal-content">
        ...
        <p>
          ...
          purposes <strong>only with your explicit written consent</strong>. You may withdraw consent at any time by contacting us through <a href="mailto:diazmoses99@gmail.com" className="underline">Email</a>.
        </p>
        ...
        <p>To exercise any of these rights, contact us through <a href="mailto:diazmoses99@gmail.com" className="underline">Email</a>. We will respond within 30 days.</p>
        ...
        <p>
          If you are a California resident, you have additional rights under the California Consumer Privacy Act (CCPA): the right to know what personal information we collect; the right to request deletion of your information; the right to opt-out of the sale of personal information (we do not sell your data); and the right to non-discrimination for exercising your rights. To exercise these rights, contact us through <a href="mailto:diazmoses99@gmail.com" className="underline">Email</a>.
        </p>
        ...
        <h2>Contact Us</h2>
        <p>
          Questions about this Privacy Policy? Contact us through <a href="mailto:diazmoses99@gmail.com" className="underline">Email</a>.
        </p>
